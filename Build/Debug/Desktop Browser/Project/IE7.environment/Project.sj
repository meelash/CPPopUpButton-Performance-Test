@STATIC;1.0;u;21;Resources/spinner.gif54;mhtml:IE7.environment/Project.sj!Resources/spinner.gifp;15;AppController.jI;21;Foundation/CPObject.jc;4904;
...
},["@action","id"]), new objj_method(sel_getUid("selectItemAtFirstIndex:"), function $AppController__selectItemAtFirstIndex_(self, _cmd, sender)
{ with(self)
{
    objj_msgSend(testButton, "selectItemAtIndex:", 0);
}
},["@action","id"])]);
}
