@STATIC;1.0;u;21;Resources/spinner.gif54;mhtml:IE7.environment/Project.sj!Resources/spinner.gifp;15;AppController.jI;21;Foundation/CPObject.ji;15;MHPopUpButton.jc;6347;
...
new objj_method(sel_getUid("testButton"), function $AppController__testButton(self, _cmd)
{ with(self)
{
return testButton;
}
},["id"]),
new objj_method(sel_getUid("setTestButton:"), function $AppController__setTestButton_(self, _cmd, newValue)
{ with(self)
{
testButton = newValue;
}
...
{ with(self)
{
    objj_msgSend(self, "populateButton:", nil);
}
},["void","CPNotification"]), new objj_method(sel_getUid("awakeFromCib"), function $AppController__awakeFromCib(self, _cmd)
{ with(self)
{
}
},["void"]), new objj_method(sel_getUid("populateButton:"), function $AppController__populateButton_(self, _cmd, sender)
{ with(self)
{
    if (objj_msgSend(testButton, "numberOfItems") == 114)
    {
        objj_msgSend(testButton, "removeAllItems");
        objj_msgSend(testButton, "addItemsWithTitles:", TEST_ARRAY2);
    }
    else
    {
        objj_msgSend(testButton, "removeAllItems");
...
{ with(self)
{
    objj_msgSend(_CPMenuWindow, "menuWindowWithMenu:font:", objj_msgSend(testButton, "menu"), objj_msgSend(objj_msgSend(testButton, "menu"), "font"));
    return;
}
},["@action","id"]), new objj_method(sel_getUid("secondPreCallOption:"), function $AppController__secondPreCallOption_(self, _cmd, sender)
{ with(self)
{
...
p;15;MHPopUpButton.jI;18;AppKit/CPControl.jc;2299;
